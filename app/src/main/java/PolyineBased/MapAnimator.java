...
public class MapAnimator {
  ...
  static final int GREEN = Color.parseColor("#FF21E784");
  ...
  public void animateRoute(GoogleMap googleMap, List<LatLng> bangaloreRoute) {
    ...
    PolylineOptions optionsBackground = new PolylineOptions().add(bangaloreRoute.get(0)).color(GREEN).width(5);
